...
export declare function generateSpeech(ctx: Context, config: Config, text: string, voiceId: string, cacheManager?: AudioCacheManager, overrideFormat?: string): Promise<Buffer | null>;
